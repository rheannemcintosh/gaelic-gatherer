<x-admin-layout :hideButton="true">
    ...
    <ul class="list-disc">
        <li class="ml-8">You will need to be available for a short quiz, roughly 5 minutes, <span class="font-bold">one hour</span> after completing the initial study.</li>
        <li class="ml-8">Another short quiz, also around 5 minutes, will be required 14 days later.</li>
    </ul>
    <p class="font-bold">
